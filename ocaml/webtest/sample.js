...
(function(){caml_register_global(6,[0,new MlString("Not_found")]);caml_register_global(5,[0,new MlString("Division_by_zero")]);caml_register_global(3,[0,new MlString("Invalid_argument")]);caml_register_global(2,[0,new MlString("Failure")]);var g=new MlString("Pervasives.do_at_exit"),f=new MlString("message");function e(d){var a=caml_ml_out_channels_list(0);for(;;){if(a){var b=a[2];try {}catch(c){}var a=b;continue;}return 0;}}caml_register_named_value(g,e);var j=self.addEventListener,i=self.postMessage;function k(h){return i(h.data.toString());}j(f.toString(),k);e(0);return;}());
